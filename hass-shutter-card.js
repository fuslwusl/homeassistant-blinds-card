  ...
  set hass(hass) {
    ...
    if (!this.card) {
      ...
      entities.forEach(function(entity) {
        ...
        let toleranceOpenClosed = 5;
        if (entity && entity.tolerance_open_closed) {
          toleranceOpenClosed = Math.max(0,Math.min(100,entity.tolerance_open_closed)); // make sure this is valid range
        }
        ...
        shutter.innerHTML = `
          ...
          <div class="sc-shutter-middle" style="flex-flow: ` + (buttonsInRow ? 'column': 'row') + (buttonsContainerReversed ? '-reverse' : '') + ` nowrap;">
            ...
            <div class="sc-shutter-buttons" style="flex-flow: ` + (buttonsInRow ? 'row': 'column') + ` wrap;">` + (tilt?`
      ...
      style.textContent = `
        .sc-shutters { padding: 16px; padding-bottom: 0; }
        .sc-shutter { margin-bottom: 2rem; overflow: hidden; }
        ...
        .sc-shutter-selector-slide { opacity: 0.5; background-image: url(data:@file/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAGCAYAAAACEPQxAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAAIGNIUk0AAHpPAACA1wAA+5gAAH6BAAB41AAA6bgAADhTAAAa8BY+DIIAAAAoSURBVHjaYjh48OBqpt+/f3sx8fHxcTFJSkoyMHFycjIwcXJyHgYMAKRuB6wLmIXlAAAAAElFTkSuQmCC); }
        .sc-shutter-tilt-100 { opacity: 1; background-image: url(data:@file/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAGCAYAAAACEPQxAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAAIGNIUk0AAHpPAACA1wAA+5gAAH6BAAB41AAA6bgAADhTAAAa8BY+DIIAAAAoSURBVHjaYjh48OBqpt+/f3sx8fHxcTFJSkoyMHFycjIwcXJyHgYMAKRuB6wLmIXlAAAAAElFTkSuQmCC); }
        .sc-shutter-tilt-90  { opacity: 1; background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAGCAYAAAACEPQxAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAClJREFUeNpiOHjw4Gqm379/ezHx8fFxMUlKSjIwcXJyMjD8//+fASDAAKxHCckpIAUyAAAAAElFTkSuQmCC); }
        .sc-shutter-tilt-80  { opacity: 1; background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAGCAYAAAACEPQxAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAACdJREFUeNpi+P//PwPT3r17vzLx8fFxMUlKSjIwcXJyMjCAJAACDACskgnJ7QEGVwAAAABJRU5ErkJggg==); }
        .sc-shutter-tilt-70  { opacity: 1; background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAGCAYAAAACEPQxAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAACRJREFUeNpi+P//PwPT3r17vzLx8fFxMUlKSjIwgMUYgAAgwAC6oQmu7EyqGQAAAABJRU5ErkJggg==); }
        .sc-shutter-tilt-60  { opacity: 1; background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAGCAYAAAACEPQxAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAACBJREFUeNpi+P//PwMTAxAwnT59+j+TpKQkAwNcDCDAAKrFCa4ekNXZAAAAAElFTkSuQmCC); }
        .sc-shutter-tilt-50  { opacity: 1; background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAGCAYAAAACEPQxAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAB1JREFUeNpi+P//PwMTAxAwnT59+j8DggsiAAIMALXdCWONsBLEAAAAAElFTkSuQmCC); }
        .sc-shutter-tilt-40  { opacity: 1; background-image: url(data:image/png;base64,); }
        .sc-shutter-tilt-30  { opacity: 1; background-image: url(data:image/png;base64,); }
        .sc-shutter-tilt-20  { opacity: 1; background-image: url(data:image/png;base64,); }
        .sc-shutter-tilt-10  { opacity: 1; background-image: url(data:image/png;base64,); }
        .sc-shutter-tilt-0   { opacity: 1; background-image: url(data:image/png;base64,); }
        ...
        .sc-shutter-top { text-align: left; margin-bottom: 1rem !important; }
      ...
      if (!_this.isUpdating) {
        shutter.querySelectorAll('.sc-shutter-position').forEach(function (shutterPosition) {
          ...
          if (invertPercentage) {
            ...
            // positionText = _this.positionPercentToText(visiblePosition, invertPercentage, alwaysPercentage, hass)     + '   ( Ξ ' + currentTiltPosition + ' %)';
            positionText = _this.positionPercentToText(visiblePosition, invertPercentage, alwaysPercentage, hass)     + ' / tilt ' + currentTiltPosition + ' %';
            if (disableEnd) {
              _this.changeButtonState(shutter, currentPosition, invertPercentage);
            }
            if (visiblePosition == 100 && offset) {
              positionText += ' ('+ (100-Math.round(Math.abs(currentPosition-visiblePosition)/offset*100)) +' %)'     + ' / tilt ' + currentTiltPosition + ' %';
            }
          }
          else  {
        ...
        /* Visualize tilt position */
        shutter.querySelectorAll('.sc-shutter-selector-slide').forEach(function (shutterTilt) {
          let tiltPosition = Math.round(currentTiltPosition / 10) * 10;
          /* sc-shutter-selector-slide sc-shutter-tilt-60 */
          shutterTilt.className="sc-shutter-selector-slide sc-shutter-tilt-" + tiltPosition;
        })
