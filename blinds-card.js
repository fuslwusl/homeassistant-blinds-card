class ShutterCard extends HTMLElement {
  set hass(hass) {
    ...
    if (!this.card) {
      ...
      style.textContent = `
        ...
        .sc-shutter-tilt-80  { opacity: 1; background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAGCAYAAAACEPQxAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAACdJREFUeNpi+P//PwPT3r17jzDx8fFxMElKSjIwcXJyMjCAJAACDACobQmWTyLchgAAAABJRU5ErkJggg==); }
        .sc-shutter-tilt-70  { opacity: 1; background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAGCAYAAAACEPQxAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAACRJREFUeNpi+P//PwPT3r171zDx8fGxM0lKSjIwgMUYgAAgwAC0dAliIF8QCQAAAABJRU5ErkJggg==); }
        .sc-shutter-tilt-60  { opacity: 1; background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAGCAYAAAACEPQxAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAACFJREFUeNpi+P//PwMTAxAwnT59ejPD48ePHRjgYgABBgDHbQv+8Ee+JwAAAABJRU5ErkJggg==); }
        .sc-shutter-tilt-50  { opacity: 1; background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAGCAYAAAACEPQxAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAB1JREFUeNpi+P//PwMTAxAwnT59uoEBwQURAAEGAK3tCORwaoixAAAAAElFTkSuQmCC); }
        .sc-shutter-tilt-40  { opacity: 1; background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAGCAYAAAACEPQxAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAACFJREFUeNpi+P//PwMTAxAwPXnyxIHp+fPnxQxwMYAAAwDIbgwXSlwzkwAAAABJRU5ErkJggg==); }
        .sc-shutter-tilt-30  { opacity: 1; background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAGCAYAAAACEPQxAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAACZJREFUeNpi+P//PwMTAxAwPXnyZDPT8+fPGZg+ffr0kwEkARBgANhMD+bv5Hn4AAAAAElFTkSuQmCC); }
        .sc-shutter-tilt-20  { opacity: 1; background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAGCAYAAAACEPQxAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAChJREFUeNpi+P//PwPT27dvzzB9//6dgen58+cMTJ8+ffrBAJIACDAAIcQS/jLaDEcAAAAASUVORK5CYII=); }
        ...
        .sc-shutter-selector-picker { background-image: url(data:image/png;base64,); }
      ...
      if (!_this.isUpdating) {
        shutter.querySelectorAll('.sc-shutter-position').forEach(function (shutterPosition) {
          ...
          if (invertPercentage) {
            ...
            positionText = _this.positionPercentToText(visiblePosition, invertPercentage, alwaysPercentage, hass)     + ' / ∡' + currentTiltPosition + ' %';
            if (disableEnd) {
              _this.changeButtonState(shutter, currentPosition, invertPercentage);
            }
            if (visiblePosition == 100 && offset) {
              positionText += ' ('+ (100-Math.round(Math.abs(currentPosition-visiblePosition)/offset*100)) +' %)'     + ' / ∡' + currentTiltPosition + ' %';
            }
          }
          else  {
  ...
  positionPercentToText(percent, inverted, alwaysPercentage, hass) {
    if (!alwaysPercentage) {
      if (percent >= 100 - 5) {
        return hass.localize(inverted?'ui.components.logbook.messages.was_closed':'ui.components.logbook.messages.was_opened').replace('wurde ', "").replace('was ', "").replace('geöffnet', "Oben").replace('opened', "Up");
      }
      else if (percent <= 5) {
        return hass.localize(inverted?'ui.components.logbook.messages.was_opened':'ui.components.logbook.messages.was_closed').replace('wurde ', "").replace('was ', "").replace('geschlossen', "Unten").replace('Closed', "Down");
      }
    }
    return percent + ' %';
  }
